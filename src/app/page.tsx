                ...
                <div className="C-12">
                  <div className="C-13 isSurgery">
                    <div className="C-18">
                      ...
                      <p className="T-15"><span className="isBox isOrange">O.P</span><span className="isBox">복부</span>복부위아래+러브+옆구리(앞뒤)</p>
                  ...
                  <div className="C-13 isSurgery">
                    <div className="C-18">
                      <div className="C-20 styleSheet"></div>
                      <p className="T-15"><span className="isBox isOrange">O.P</span><span className="isBox">복부</span>가멘트-복부(여자용)</p>
                      <div className="C-21 styleSheet isStomach"></div>
                    </div>
                    <div className="C-19">
                      <p className="T-14">진행중</p>
                  ...
                  <div className="C-13 isLams">
                    <div className="C-18 isCompleted">
                      <div className="C-20 styleSheet"></div>
                      <p className="T-15"><span className="isBox isYellow">시술</span><span className="isBox">복부</span>지흡후관리-RF(병행)</p>
                      <div className="C-21 styleSheet isStomach"></div>
                    </div>
                  ...
                  <div className="C-13 isLams">
                    <div className="C-18 isCompleted">
                      <div className="C-20 styleSheet"></div>
                      <p className="T-15"><span className="isBox isYellow">시술</span><span className="isBox">복부</span>지흡후관리-엔더(병행)</p>
                      <div className="C-21 styleSheet isStomach"></div>
                    </div>
                    <div className="C-19 isCompleted">
                      <p className="T-14">종료<span className="isDate">24.11.14<br/>15:32</span></p>
                  ...
                  <div className="C-13 isLams">
                    <div className="C-18 isCompleted">
                      <div className="C-20 styleSheet"></div>
                      <p className="T-15"><span className="isBox isYellow">시술</span><span className="isBox">복부</span>지흡후관리-카복시(병행)</p>
                      <div className="C-21 styleSheet isStomach"></div>
                    </div>
                    <div className="C-19 isCompleted">
                      <p className="T-14">종료<span className="isDate">24.11.14<br/>15:32</span></p>
